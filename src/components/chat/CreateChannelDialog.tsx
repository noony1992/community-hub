      ...
      <div className="bg-card border border-border rounded-xl p-6 w-96 shadow-2xl" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="mb-4">
          ...
          <div className="flex gap-2">
            <button onClick={() => setType("text")} className={`flex-1 flex items-center gap-2 px-3 py-2.5 rounded-md border text-sm font-medium transition-colors ${type === "text" ? "border-primary bg-primary/10 text-foreground" : "border-border text-muted-foreground hover:text-foreground"}`}>
